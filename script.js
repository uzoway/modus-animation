...
function initializeAnimation() {
    const loaderAnimationTl = gsap.timeline({delay: 0.7, defaults: { ease: "ease-out-quad" }});
      
    loaderAnimationTl.to(".preloader__text span", {
      y: 0,
      duration: 1,
    })
    ...
    .to(".container__video .video__wrapper .video", {
      scaleX: 1,
      duration: 1.5,
      ease: "ease-in-out-circ",
    }, "<0.8")
    .to([".navigation__logo .navigation__logo--text",
    ...
    .to(".container__heading1 .heading__line span", {
      y: 0,
      stagger: {
        amount: 0.23
      },
    }, "<0.45")
    .to(".container__heading2 .heading__line span", {
      y: 0,
      stagger: {
        amount: 0.23
      },
    ...
    .to([".video__wrapper .video__duration span",
